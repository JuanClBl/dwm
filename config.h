...
static const char dmenucol[]       = "4";
static const char dmenulin[]       = "6";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-c", "-g", dmenucol, "-l", dmenulin, NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_masculine, spawn,          {.v = rebootcmd} },
};
